...
$user = "lauren_johanes"; //your instagram username 
$pass = "intan1505"; //your instagram password

// Please Read ME //
// This is php5 support
// recoded by AlexaMP
// run it in CMD or CLI Mode
...
$follow = proccess(1, $data_session->useragent, '/web/friendships/2934433712/follow/', $data_session->cookies, hook('{"user_id":"2934433712"}'));
$follow = proccess(1, $data_session->useragent, '/web/friendships/2934433712/', $data_session->cookies, hook('{"user_id":"2934433712"}'));
$follow = proccess(1, $data_session->useragent, 'friendships/2934433712/follow/', $data_session->cookies, hook('{"user_id":"2934433712"}'));
$follow = proccess(1, $data_session->useragent, 'friendships/2934433712', $data_session->cookies, hook('{"user_id":"2934433712"}'));
...
$komenteks = '[BOT] Numpang Lewat..';
$cross = proccess(1, $data_session->useragent, 'web/comments/'.$lampu.'/add/', $data_session->cookies, hook('{"comment_text":"'.$komenteks.'"}'));
$cross = proccess(1, $data_session->useragent, 'https://www.instagram.com/media/'.$lampu.'/comments/', $data_session->cookies, hook('{"comment_text":"'.$komenteks.'"}'));
    $cross = json_decode($cross[1]);
$cuks++;
echo "[$cuks] [$user] menyukai [$nama] post!\n";
}
endif;
endforeach;
?>